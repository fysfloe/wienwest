<div class="participants lineup 4-1-3-2">
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="col-md-4 col-md-offset-4 back">
                @if(isset($positions->dm))
                <li class="col-md-12 " data-id="{{ $positions->dm->id }}">

                    <div class="row">
                        <div class="image">
                            <div class="circular" style="background-image:url({{ asset('img/cartoons') . '/' . $positions->dm->avatar . '.png' }})"></div>
                        </div>
                        <div class="number">
                            <div class="big-number">{{ $positions->dm->number }}</div>
                        </div>
                        <div class="name">
                            {{ $positions->dm->firstname }} {{ $positions->dm->surname }}
                        </div>
                    </div>

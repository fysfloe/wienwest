...
@section('content')
	<div class="panel-body">
		...
		<ul class="league-games games">
			@foreach($upcoming as $game)
				...
				@if(Auth::user()->hasRole('admin'))
					{!! Form::open(array('onsubmit' => 'confirm("Willst du dieses Spiel wirklich löschen?"', 'class' => 'form-inline', 'method' => 'DELETE', 'route' => array('league_games.destroy', $game->id))) !!}
		...
		<ul class="league-games games past-games">
